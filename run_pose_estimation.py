    ...
    while True:
        ...
        if True:
            ...
            while True:
                ...
                image_array1 = np.asarray(resized_array).astype('float32')
                image_array1 = np.expand_dims(image_array1, 0)
                interpreter1.set_tensor(input_details[0]['index'], image_array1)
                interpreter1.invoke()
                ...
                cv2.putText(image_array, text, (20,20), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
