...
# -*- coding: utf-8 -*-
"""
A YOLOv3 based person detection process module ported from:
...
def detect_person(image, model, anchors, class_names, model_input_shape, person_class_name='person'):
    ...
    for box, cls, score in zip(boxes, classes, scores):
        # filter bbox to only return person detections
        if class_names[cls] == person_class_name:
...
def get_square_box(box, image_size):
